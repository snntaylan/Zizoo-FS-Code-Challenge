...
import { CHALLENGE_PROVIDERS } from '../queries/ChallengeProviders';
import ProvideItem from "./provide-item";
...
class Search extends Component {
     ...
     */
    async getData() {
        let response = await client.query({ query: CHALLENGE_PROVIDERS });
